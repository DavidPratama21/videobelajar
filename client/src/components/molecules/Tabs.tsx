  ...
  return (
    <div className="flex overflow-x-scroll no-scrollbar transition-all duration-300 ease-in-out">
      {TabsList.map((tab, id) => (
        ...
        >
          <span
            className={`py-3 pr-9 font-medium text-sm sm:text-base leading-[140%] tracking-[0.2px] transition-all duration-300 ease-in-out 
          ...
          <span
            className={`h-1.5 w-13 rounded-[10px] transition-all duration-300 ease-in-out
              ${
                activeTab === tab
